...
# We have three transcripts that to demonstrate the function \code{modify_transcripts_merge}:
...
# Run the function
test <- modify_transcripts_merge(trans_destination, trans_updates)
...
#Export
act::textgrid_export( t=test, outputPath=path)
